...
<body>
	...
	<div id="smarthealth" class="page-section tipoColchonA">
		<div class="container">
			<div class="col-xs-12 col-sm-6">
				<img class="img-responsive" src="images/smarthealths.png" style="max-width:332px;"/>				<h3 class="newh3">
			...
			<div class="col-xs-12 col-sm-6">
				...
				<img class="persona" src="images/persona5.png" />			</div>
		</div>
	</div>
	<div class="container-fluid nextBtn nextA">
		<div class="col-xs-12">
	...
	<div id="smarthealth2" class="page-section tipoColchonB">
		<div class="container">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="altnube"></div>
				<img class="img-responsive" src="images/smarthealth2.jpg" />			</div>
		</div>
	</div>
	<div class="container-fluid nextBtn nextB">
		<div class="col-xs-12">
		...
		<div class="container">
			...
			<ul id="tab">
				<li class="active">
					...
					<div class="col-xs-12 col-sm-6" style="margin:0; padding:0;">
						<img class="img-responsive" src="images/texturas.png" />					</div>    
					...
					<div class="contact-details">
						<div class="company-phone">
							<a style="text-decoration:none;">
								<img src="images/celular.png" />								0800 3484
							</a>
						</div>
						
						<i>
							<img src="images/contact.png" />						</i>
						
						<h5 class="company-email">info@divino.com.uy</h5>
						
						<i>
							<img src="images/markerch.png" />						</i>
			...
			<ul class="socials-icons">
				<li>
					<a href="https://www.facebook.com/divinouruguay" target="_blank">
						<img src="images/btn_facebook_pie.png" />					</a>
				</li>
				<li>
					<a href="https://twitter.com/Divino_UY" target="_blank">
						<img src="images/btn_twitter_pie.png" />					</a>
				</li>
				<li>
					<a href="http://tienda.mercadolibre.com.uy/divino" target="_blank">
						<img src="images/btn_mercadolibre_pie.png" />					</a>
				</li>
			</ul> 
